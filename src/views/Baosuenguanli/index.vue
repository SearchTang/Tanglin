      ...
      <div class="zhenti">
        ...
        <div class="xiaban">
          <div class="neir">
            ...
            <div class="neirr2">
              <router-link to="../Xingzhengbaoshuen" tag="span" class="yi">
                <el-button plain
              ...
              <router-link to="../Bianyibaoshuen" tag="span" class="yi">
                <el-button plain
          ...
          >
            ...
            <el-table-column prop="address" label="地址" show-overflow-tooltip>
               <Chakan></Chakan>
                <router-link to="../Bianyibaoshuen" tag="span"
